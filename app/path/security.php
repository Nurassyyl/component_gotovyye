                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                    <input type="hidden" name="id" id="simpleinput" class="form-control" value="<?php echo $idUsers['id']; ?>">
                                    <label class="form-label" for="simpleinput">Email</label>
                                    <input type="text" name="email" id="simpleinput" class="form-control" 
                                    value="<?php echo $idUsers['email']; ?>">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    value="<?php $idUsers['password']; ?>">
                                </div>

                                <!-- password confirmation-->
                                <div class="form-group">
                                    <label class="form-label" for="simpleinput">Подтверждение пароля</label>
                                    <input type="password" name="newPassword" id="simpleinput" class="form-control" value="<?php $idUsers['password']; ?>">
                                </div>
