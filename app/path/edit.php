...
<body>
    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
        ...
        <form action="handlerUpdate" method="post">
            <div class="row">
                <div class="col-xl-6">
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                    <input type="hidden" name="id" id="simpleinput" class="form-control" 
                                    value="<?php echo $idUsers['id'];?>">
                                    <label class="form-label" for="simpleinput">Имя</label>
                                    <input type="text" name="username" id="simpleinput" class="form-control" 
                                    value="<?php echo $idUsers['username'];?>">
                                </div>
